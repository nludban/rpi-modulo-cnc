...
uint8_t const desc_configuration[] = {
    ...
    // _itfnum, _stridx, _ep_notif, _ep_notif_size, _epout, _epin, _epsize
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC_0,		// interface number = 0
		       4,			// string index = stdio
		       EPNUM_CDC_0_NOTIF, 8,	// notif + size
		       EPNUM_CDC_0_OUT,		// out
		       EPNUM_CDC_0_IN, 64),	// in + size
...
// buffer to hold the string descriptor during the request +1 for nul
